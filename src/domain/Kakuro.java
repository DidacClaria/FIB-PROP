...
public class Kakuro {
    ...
    public void Kakuro2(int x, int y, int wcells, int bcells, int dif) {
        this.numRows = x;
        this.numColumns = y;
        this.cells = new Cell[numRows][numColumns];
        this.solutions = 0;
        ...
        HashMap<Integer, ArrayList< ArrayList<Integer> > > comb = combinació();
    ...
    HashMap<Integer, ArrayList< ArrayList<Integer> > > combinació(){
